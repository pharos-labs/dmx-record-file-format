# DMX Recording File Format Documentation

This project publishes documentation on the Pharos Designer DMX Recording file format to ReadTheDocs, or can be built locally.
